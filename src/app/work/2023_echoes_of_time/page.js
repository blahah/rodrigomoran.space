...
const description = [
  ...
  (<i key={1}>«This visual piece is accompanied by the song 1956-1977 by Andrey Guryanov, that explores the history and sonic essence of the Soviet Union&apos;s historical trajectory. In contrast, my work delves into the question of what reality is made of and, ultimately, how we engage with it. I have chosen to include this track as a calling for peace, once again.»</i>),
